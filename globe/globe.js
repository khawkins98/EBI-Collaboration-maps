...
DAT.Globe = function(container, opts) {
  ...
  function addData(data, opts) {
    ...
    } else if (opts.format === 'label') {
      step = 5;
      // colorFnWrapper = function(data, i) { return colorFn(data[i+3]); }
      colorFnWrapper = function(data, i) { return markerColors[data[i+3]]; }
    } else {
...
//        size = data[i + 2];
  ...
  function addPoint(lat, lng, size, color, subgeo, label) {
  ...
  // -- text labels
  // via view-source:http://stemkoski.github.io/Three.js/Labeled-Geometry.html
